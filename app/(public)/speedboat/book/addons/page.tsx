...
import { Container, Box, Group, Text, SimpleGrid, Stack, Title, Grid } from '@mantine/core';
import { IconArrowLeft } from '@tabler/icons-react';
import { Header } from '@/components/layout/header';
import { Footer } from '@/components/layout/footer';
import { ProgressIndicator } from '@/components/speedboat/progress-indicator';
import { FilterButtons } from '@/components/speedboat/filter-buttons';
import { AddOnCard } from '@/components/speedboat/addon-card';
import { BookingSummary } from '@/components/speedboat/booking-summary';
import { AddOnDetailsModal } from '@/components/speedboat/addon-details-modal';
  ...
  return (
    <Box style={{ minHeight: '100vh', backgroundColor: '#f8f9fa' }}>
      ...
      <Container size="xl" pt="xl">
        <Link href="/speedboat/book" style={{ textDecoration: 'none' }}>
          <Group gap="xs" style={{ cursor: 'pointer', color: '#284361', transition: 'color 0.2s ease' }}>
            <IconArrowLeft size={20} />
            <Text fw={500} style={{ ':hover': { color: '#1f3450' } }}>Back to Passenger Info</Text>
          </Group>
        </Link>
      </Container>
        ...
        <Grid gutter="xl">
          ...
          <Grid.Col span={{ base: 12, lg: 4 }}>
            <BookingSummary 
              ...
              onContinue={() => router.push('/speedboat/book/payment')}
