...
import { BookingReview } from '@/components/beachclub/booking-review';
import { PaymentSummary } from '@/components/beachclub/payment-summary';
import { PaymentMethodSelector } from '@/components/beachclub/payment-method-selector';
...
export default function PaymentPage() {
  ...
  const handlePayment = () => {
    ...
    router.push('/beachclub/book/confirmation');
  };
