        ...
        <Stack gap="md">
          ...
          <Stack gap="md">
            <Group align="flex-start" gap="md">
              ...
              <Stack gap="xs">
                <Text fw={500} c="dark">Location: Tanjung Benoa, Bali</Text>
                <Text size="sm" c="dimmed">Activity: Jet Ski Guided Session</Text>
            ...
            <Group align="center" gap="md">
              ...
              <Text c="dark">Session: 10:00 AM – 11:00 AM</Text>
            </Group>
          </Stack>
        </Stack>
